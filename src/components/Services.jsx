      ...
      }
      {
        isactive === 2 && (
          <div className='product-section'>
            <ProductCard plan="Lite" storage={30} actualprice={500} disprice={480} description1="for six month" />
            <ProductCard plan="Basic" storage={100} actualprice={1400} disprice={1350} description1="for six month" />
            <ProductCard plan="Standard" storage={200} actualprice={2000} disprice={1870} description1="for six month" />
          </div>
        )
      }
      {
        isactive === 3 && (
          <div className='product-section'>
            <ProductCard plan="Lite" storage={30} actualprice={800} disprice={680} description1="for one year" />
            <ProductCard plan="Lite" storage={100} actualprice={1800} disprice={1620} description1="for one year" />
            <ProductCard plan="Lite" storage={200} actualprice={2600} disprice={2390} description1="for one year" />
          </div>
        )
      }
    </div>
