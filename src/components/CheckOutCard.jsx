...
function CheckOutCard({ open, setOpen, plandetails }) {
  ...
  const handleProceed = async () => {
    ...
    const planName = plandetails.plan + plandetails.description;
    const payload = {
      name: planName,
      price: plandetails.disprice,
      user,
    };
    ...
    openRazorpayPopup({ orderId, planName, user, setOpen });
  };
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="font-medium text-gray-900 dark:text-white">
                {plandetails.plan}{plandetails.description}
              </p>
            </div>
            <div className="text-right">
              <p className="text-sm text-gray-500 dark:text-gray-400">Price</p>
              <p className="text-lg font-bold text-indigo-600 dark:text-indigo-400">
                ₹{plandetails.disprice}
              </p>
            </div>
          </div>
